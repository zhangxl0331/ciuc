...
function show_header() {
	...
	$version = UC_VERSION;
	$release = UC_RELEASE;
	$install_lang = lang(UC_INSTALL_LANG);
...
<title>$title</title>
<link rel="stylesheet" href="../{$apppath}themes/install/css/style.css" type="text/css" media="all" />
...
function initinput() {
	window.location='<?php echo 'install?step='.($step+1);?>';
}
</script>
	<div class="main">
